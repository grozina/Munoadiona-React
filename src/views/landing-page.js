...
const LandingPage = (props) => {
  return (
    <div className="landing-page-container1">
      <Helmet>
        <title>Muno/adiona</title>
        <meta property="og:title" content="Muno/adiona" />
      </Helmet>
        ...
        <nav data-role="Header" className="landing-page-navbar">
          ...
          <div className="landing-page-right-side1">
            <LinksContainer
              text={
                <Fragment>
                  <span className="landing-page-text10">About</span>
                </Fragment>
              }
              text1={
                <Fragment>
                  <span className="landing-page-text11">For businesses</span>
                </Fragment>
              }
              text2={
                <Fragment>
                  <span className="landing-page-text12">Contact</span>
                </Fragment>
              }
            ></LinksContainer>
            <a href="#main-section" className="landing-page-link10">
              <SolidButton button="Log in"></SolidButton>
            </a>
          </div>
            ...
            <div className="landing-page-nav">
              ...
              <div className="landing-page-right-side2">
                <div className="landing-page-links-container1">
                  <span className="landing-page-text13">Home</span>
                  <span className="landing-page-text14">About</span>
                  <span className="landing-page-text15">Tour Packages</span>
                  <span>Contact</span>
                </div>
        ...
        <div className="landing-page-hero">
          <div className="landing-page-content-container">
            ...
            <h2 className="landing-page-subheading">
              - we&apos;ll pick everything out for you
            </h2>
            <div className="landing-page-container2"></div>
          </div>
          <div className="landing-page-container3"></div>
          <SolidButton
            button="Business trip to Chicago next week"
            rootClassName="solid-buttonroot-class-name"
          ></SolidButton>
      ...
      <div id="main-section" className="landing-page-main">
        <h1 className="landing-page-text19">Recommendations for trips</h1>
      ...
      <div
        ...
        className="landing-page-language-switcher list-item"
      >
        <div
          data-thq="thq-dropdown-toggle"
          className="landing-page-language-switcher-toggle"
        >
          <span className="landing-page-language-name">{locale?.['name']}</span>
          <div
            data-thq="thq-dropdown-arrow"
            className="landing-page-dropdown-arrow"
          >
            <svg viewBox="0 0 1024 1024" className="landing-page-icon27">
        ...
        <ul
          ...
          className="landing-page-language-switcher-list"
        >
          <div>
            {locales.map((all_languages, index) => (
              <Fragment key={index}>
                <div className="landing-page-language-switcher-item">
